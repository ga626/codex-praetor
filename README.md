...
当前产品化目标版本是 **0.5.0-alpha**。这一版修正 Windows 维护任务的 fail-open：注册或验证失败时，稳定 activation 不会再被错误写成成功。

[下载 0.5.0-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.5.0-alpha) · [安装指南](docs/user/installation.zh.md) · [排错指南](docs/user/troubleshooting.zh.md) · [路线图](docs/roadmap.md)
...
1. 打开 [Release 页面](https://github.com/ga626/codex-praetor/releases/tag/v0.5.0-alpha)，下载 Windows 安装 zip：`codex-praetor-setup-0.5.0-alpha.zip`。
