...
当前产品化目标版本是 **0.16.1-alpha**。这一版把真实 `code_change` 固定为冻结 commit 的隔离 Git worktree：只有可审查的真实 diff、范围检查、不可修改文件检查和 Codex 独立验收共同通过，才可能成为事实记录。
...
[下载 0.16.1-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.16.1-alpha) · [安装指南](docs/user/installation.zh.md) · [排错指南](docs/user/troubleshooting.zh.md) · [路线图](docs/roadmap.md)
...
1. 打开 [Release 页面](https://github.com/ga626/codex-praetor/releases/tag/v0.16.1-alpha)，下载 Windows 安装 zip：`codex-praetor-setup-0.16.1-alpha.zip`。
