...
当前产品化目标版本是 **0.16.3-alpha**。这一版修复 Windows PowerShell 写出的 UTF-8 BOM 让有效任务 ledger 被能力画像误判为损坏的问题；它只修正只读解析，不改写历史账本，也不把旧记录提升为 provider 能力。
...
[下载 0.16.3-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.16.3-alpha) · [安装指南](docs/user/installation.zh.md) · [排错指南](docs/user/troubleshooting.zh.md) · [路线图](docs/roadmap.md)
...
1. 打开 [Release 页面](https://github.com/ga626/codex-praetor/releases/tag/v0.16.3-alpha)，下载 Windows 安装 zip：`codex-praetor-setup-0.16.3-alpha.zip`。
