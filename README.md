...
当前公开版本是 **0.1.2-alpha**。这一版把 Codex Praetor 从 dry-run 和状态查询推进到真实 worker 派发、结果读取、计划任务推进和 Codex 验收记录。

[下载 0.1.2-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.1.2-alpha) · [安装指南](docs/user/installation.zh.md) · [排错指南](docs/user/troubleshooting.zh.md) · [路线图](docs/roadmap.md)
...
1. 打开 [Release 页面](https://github.com/ga626/codex-praetor/releases/tag/v0.1.2-alpha)，下载当前已发布的 Windows 安装 zip：`codex-praetor-setup-0.1.2-alpha.zip`。

   如果你更习惯 PowerShell，也可以运行：

   ```powershell
   Invoke-WebRequest -Uri "https://github.com/ga626/codex-praetor/releases/download/v0.1.2-alpha/codex-praetor-setup-0.1.2-alpha.zip" -OutFile ".\codex-praetor-setup-0.1.2-alpha.zip"
   Expand-Archive .\codex-praetor-setup-0.1.2-alpha.zip .\codex-praetor-setup-0.1.2-alpha
   cd .\codex-praetor-setup-0.1.2-alpha
   ```
