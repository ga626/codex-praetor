...
$releaseNotes = Join-Path $ProjectRoot "docs\release\release-notes-0.16.22-alpha.md"
Assert-True (Test-Path -LiteralPath $releaseNotes -PathType Leaf) "0.16.22-alpha release notes are missing."
