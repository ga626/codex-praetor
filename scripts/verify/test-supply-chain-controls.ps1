...
$releaseNotes = Join-Path $ProjectRoot "docs\release\release-notes-0.16.23-alpha.md"
Assert-True (Test-Path -LiteralPath $releaseNotes -PathType Leaf) "0.16.23-alpha release notes are missing."
