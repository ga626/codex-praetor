...
$releaseNotes = Join-Path $ProjectRoot "docs\release\release-notes-0.6.3-alpha.md"
Assert-True (Test-Path -LiteralPath $releaseNotes -PathType Leaf) "0.6.3-alpha release notes are missing."
