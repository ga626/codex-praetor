...
$releaseNotes = Join-Path $ProjectRoot "docs\release\release-notes-0.9.5-alpha.md"
Assert-True (Test-Path -LiteralPath $releaseNotes -PathType Leaf) "0.9.5-alpha release notes are missing."
