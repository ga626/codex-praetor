...
$releaseNotes = Join-Path $ProjectRoot "docs\release\release-notes-0.16.7-alpha.md"
Assert-True (Test-Path -LiteralPath $releaseNotes -PathType Leaf) "0.16.7-alpha release notes are missing."
