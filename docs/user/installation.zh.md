...
```text
https://github.com/ga626/codex-praetor/releases/tag/v0.16.19-alpha
```
...
真实派工前，你需要至少一个外部 CLI 已安装、已授权，并通过只读 canary。`0.16.19-alpha` 使用 Qoder Agent SDK 或 CodeBuddy ACP 获取结构化进展；你不需要手工选择连接协议。
