...
Date: 2026-07-19
Target release: `0.7.0-alpha`

Status: `v0.6.2-alpha` is a public release incident and must not be activated or overwritten. `v0.7.0-alpha` is the explicit recovery version and is published automatically by `Release On Main` after this PR reaches `main`.
