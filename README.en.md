...
[Download 0.16.22-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.16.22-alpha) · [Chinese installation guide](docs/user/installation.zh.md) · [Chinese troubleshooting guide](docs/user/troubleshooting.zh.md)
...
```powershell
Invoke-WebRequest -Uri "https://github.com/ga626/codex-praetor/releases/download/v0.16.22-alpha/codex-praetor-setup-0.16.22-alpha.zip" -OutFile ".\codex-praetor-setup-0.16.22-alpha.zip"
Expand-Archive .\codex-praetor-setup-0.16.22-alpha.zip .\codex-praetor-setup-0.16.22-alpha
cd .\codex-praetor-setup-0.16.22-alpha
```
...
The 0.16.22-alpha source line records runtime identity alongside logical tasks, immutable worker attempts, evidence, and Codex supervisor verdicts. A worker process exit or same-name tool list is not enough to advance a release; Codex must verify the loaded runtime generation.
