...
Current productization target: **0.3.0-alpha**.

[Download 0.3.0-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.3.0-alpha) · [Chinese installation guide](docs/user/installation.zh.md) · [Chinese troubleshooting guide](docs/user/troubleshooting.zh.md)
...
```powershell
Invoke-WebRequest -Uri "https://github.com/ga626/codex-praetor/releases/download/v0.3.0-alpha/codex-praetor-setup-0.3.0-alpha.zip" -OutFile ".\codex-praetor-setup-0.3.0-alpha.zip"
Expand-Archive .\codex-praetor-setup-0.3.0-alpha.zip .\codex-praetor-setup-0.3.0-alpha
cd .\codex-praetor-setup-0.3.0-alpha
```
...
The 0.3.0-alpha source line binds generation, provider readiness, durable jobs, completion records, and promotion receipts to one runtime contract. A worker process exiting successfully is not enough to advance dependent tasks; Codex must verify and record the result first.
