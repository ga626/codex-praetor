...
Current productization target: **0.7.0-alpha**. This release connects release intent, version consistency, immutable GitHub Releases, and automatic post-merge remote verification; the Codex Desktop host still requires a fresh-context check.

[Download 0.7.0-alpha](https://github.com/ga626/codex-praetor/releases/tag/v0.7.0-alpha) · [Chinese installation guide](docs/user/installation.zh.md) · [Chinese troubleshooting guide](docs/user/troubleshooting.zh.md)
...
The 0.7.0-alpha source line records runtime identity alongside logical tasks, immutable worker attempts, evidence, and Codex supervisor verdicts. A worker process exit or same-name tool list is not enough to advance a release; Codex must verify the loaded runtime generation.
